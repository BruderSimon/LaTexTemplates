...
\usepackage{enumitem}
\usepackage[
            pdftitle={Curriculum Vitae of Simon Engel},
            pdfauthor={Simon Engel},
            hidelinks
            ]{hyperref}
\usepackage{fancyhdr}
...
%     \textbf{\Huge \scshape Simon Engel} \\
%      \begin{itemize}[leftmargin=0.15in, label={}]
%       \item{
%           \raisebox{-0.1\height}\faPhone\ +XX-XXXXXXXXXX\\
...
%      \raggedleft
%      \includegraphics[width=0.8\textwidth, height=1\textwidth]{img.jpg}
%    \end{minipage}
% \end{tabular*}
